...
import  './SliderComponentNegative.css';
import {useState, useEffect} from "react"


const SliderComponentNegative = ({vodopad1, vodopad2, vodopad3, vodopad4, time}) => {
...
const nextImgIndex = activeIndex === img.length - 1 ? 0 : activeIndex + 1
    return <div>
        ...
        <div className="slider-img slider-img-nexts"
                key={nextImgIndex}>
            {img[nextImgIndex]}
        </div>
    </div>
...
export default SliderComponentNegative;
