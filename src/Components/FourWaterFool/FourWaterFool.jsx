...
const FourWaterFool = () => {
    const time = 5000;
    return (
        <div id="fourWaterFoll"className={four.wrapperWater}>
            ...
            <div className={four.discription}>
                ...
                <p className={four.discriptionText}>
                    ...
                    Посещение бесплатное.
                     Добраться до достопримечательности можно на
                ...
                <p className={four.place}>Расположен: Крым,  Балаклавский р-н, с. Передовое Координаты:4444.5196, 33.8095</p>
            </div>
        </div>
    );
};
